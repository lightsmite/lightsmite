...
USER_NAME = os.environ['USER_NAME'] # 'lightsmite'
...
if __name__ == '__main__':
    """
    lightsmite, adapted from Andrew Grant (Andrew6rant), 2022-2025
    """
    ...
    # 'Uptime' is the age of the GitHub account, so it needs no hardcoded birthday
